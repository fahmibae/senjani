...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <a href="<?php echo site_url('c_pesanan/index') ?>" class="btn btn-warning"><i class="fa fa-arrow-left"></i>&nbsp;Kembali</a></h1>
          <hr>
          <div class="row">
            <div class="col-lg-6">
          <div class="card shadow mb-4">
                <table class="table table-bordered">
                  <?php
                    $pesanan_harian = $this->db->query("SELECT * FROM pesanan WHERE id_pesanan='$pesanan->id_pesanan'");
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="card shadow mb-4">
                  <div class="card-body">
                  <form action="<?php echo base_url('c_pesanan/tambah_aksi_hutang')?>" method="post" class="form-horizontal">
